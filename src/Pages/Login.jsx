            ...
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl rounded-lg border">
                ...
                <form onSubmit={handleSubmit} className="card-body">
                    ...
                    <div className="form-control">
                        ...
                        <Link to='' data-tip="Update Soon..." className="tooltip font-semibold text-red-600 link-hover text-start"> Forgotten account ?</Link>

                    </div>
                    <div className="form-control mt-6">
                        <button className="btn btn-neutral">Login</button>
                        <Link to="/register" className="btn btn-link text-lg text-yellow-700">Create New Account</Link>
